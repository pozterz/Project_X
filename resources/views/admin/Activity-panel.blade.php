		...
		<div class="col s12 m12 l12">
			<div class="card-panel">
				<div class="card-content">
					<span class="card-title flow-text">Manage Activities</span><br/><br/>
							...
							<table class="centered highlight bordered">
								...
								<tbody>
									...
									<tr>
										...
										<td>
											<a href="{{ url('admin/deleteActivities') }}/{{$mainqueue->id}}" class="btn-floating waves-effect waves-light red btn"><i class="fa fa-close"></i></a>
										</td>
									</tr>
									@endforeach
								</tbody>
