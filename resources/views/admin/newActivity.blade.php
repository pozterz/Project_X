								...
								<div class="row">
									<div class="input-field col s6">
										...
										@if ($errors->has('service_time'))
											<label for="service_time" data-error="{{ $errors->first('service_time') }}">Service Time</label>
										@else
											<label for="service_time" data-error="Please input 6 charactor or more" data-success="Validated">Service Time</label>
										@endif
									</div>
									<div class="input-field col s6">
